...
export default function Home() {
  ...
  // ✅ Slider içerikleri (istersen metinleri değiştiririz)
  const slides = useMemo(
    () => [
      {
        kicker: "✨ Premium Beauty Store",
        title: "Yeni Sezon\nGlow Seçkisi",
        desc: "En yeni ürünleri keşfet • sepete ekle • ödeme adımında tamamla.",
        cta: "Mağazaya Git",
        to: "/shop",
      ...
      },
      {
        kicker: "🔥 Limited",
        title: "Bestseller\nKoleksiyon",
        desc: "En çok tercih edilen ürünler şimdi vitrin bölümünde.",
        cta: "Ürünleri Gör",
        to: "/shop",
      ...
      },
      {
        kicker: "💎 Luxury Look",
        title: "Cilt & Makyaj\nRutinin",
        desc: "Modern görünüm, premium alışveriş deneyimi.",
        cta: "Hesap Oluştur",
        to: "/register",
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <Kpi title="Premium Seçki" desc="Özenle seçilmiş ürünler" />
                <Kpi title="Modern Tasarım" desc="Sephora vibe UI" />
              </div>
            </div>

            {/* RIGHT - lux preview card */}
            <div className="card" style={{ background: "rgba(255,255,255,.75)" }}>
              <div className="card-pad">
                ...
                <div style={{ display: "grid", gap: 10 }}>
                  <PromoRow label="Çok Satan" text="Mat Ruj & Rimel" />
                  <PromoRow label="Yeni Sezon" text="Glow Paletleri" />
                  <PromoRow label="Trend" text="Full Coverage Fondöten" />
                </div>
